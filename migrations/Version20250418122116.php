 ...
 */
final class Version20250418122116 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE vtk_customer_ask (id INT AUTO_INCREMENT NOT NULL, request_date DATE NOT NULL, pickup_address LONGTEXT DEFAULT NULL, pickup_date DATE DEFAULT NULL, status VARCHAR(50) DEFAULT NULL, notes LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', updated_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE vtk_customers_ask (id INT AUTO_INCREMENT NOT NULL, customer_id INT DEFAULT NULL, INDEX IDX_96F438C49395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vtk_customers_ask ADD CONSTRAINT FK_96F438C49395C3F3 FOREIGN KEY (customer_id) REFERENCES vtk_customer (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vtk_document ADD CONSTRAINT FK_C7FEE735B93F8B63 FOREIGN KEY (ask_id) REFERENCES vtk_customers_ask (id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vtk_materials_lot ADD CONSTRAINT FK_F5AA327DB93F8B63 FOREIGN KEY (ask_id) REFERENCES vtk_customers_ask (id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vtk_customers_ask DROP FOREIGN KEY FK_96F438C49395C3F3
        SQL);
        $this->addSql(<<<'SQL'
