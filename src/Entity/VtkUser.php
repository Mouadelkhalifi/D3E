...
#[ApiResource]
class VtkUser implements UserInterface, PasswordAuthenticatedUserInterface
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    {
        // Si vous stockez des informations d'identification temporaires, effacez-les ici
    }
